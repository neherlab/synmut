...
author:     Fabio Zanini
date:       15/06/12
content:    Calculate the fixation probability of synonymous derived alleles in
            the V loops and flanking regions.
'''
# Standard modules
...
# Labels for the plot
labels = {'loops': 'V3-V5 loops',
          'flank': 'flanking stems'}
        ...
        for iji, nu0s in enumerate(nu0ss):
            ...
            for i in xrange(n-1):
                ...
                if len(alleles):
                    ...
                    # Divide by class
                    all_cla['loops'] = [a for a in alleles if is_loops[a[1]]]
                    all_cla['flank'] = [a for a in alleles if is_flank[a[1]]]
