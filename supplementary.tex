...
effect with a probability proportional to the frequency of the escaped variant
per generation. Specifically, the selection effect of the escape mutations is
