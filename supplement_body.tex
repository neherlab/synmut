...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.6\linewidth]{simulations_syn_gentime_2days.pdf}
\caption{
Results of simulations with alternative parameters.
Panel A) Like \figurename~4B in the main text, but simulations are performed using a
