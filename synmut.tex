...
from $10^{-5} - 4\times 10^{-5}$ per day. Different virions within an
...
simulate populations between $N=10^4$ and $5 \times 10^4$. Larger populations
...
and $s_d$ between $2 \times 10^{-4}$ to $2\times 10^{-2}$ per day.
...
$k_A=0.005$ per day. We simulate a range from $10^{-3.8}$ to $2\times 10^{-2}$ per day.
