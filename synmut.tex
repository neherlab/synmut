...
$t$, we calcate the fraction that are still observed at later times $t+\Delta t$. Plotting this fraction against the time interval $\Delta t$, we see that
...
\begin{figure}
\begin{center}
\subfloat{\includegraphics[height=0.47\linewidth]{reactivities_histograms_syn.pdf}\label{fig:SHAPEA}}
