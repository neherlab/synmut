...
resulting in rapid adaptation of HIV-1 proteins. When cytotoxic CD8${}^+$ T-cells
...
of similar structural elements, but individual base pairings differ widely \citep{pollom_comparison_2013}. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DO WE WANT TO KEEP THIS LAST SENTENCE?
Extending the analysis of fixation
probabilities to the nonsynonymous variants, we show that time-dependent
selection or competition of escape mutations inside the same epitope are
necessary to explain the observed patterns of spread and extinction.
