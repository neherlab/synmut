...
Restricted to the \shankaregion area, the data from
...
alleles as a function of $\nu_0$ in \shankaregion is reduced relative to the neutral
...
\FIG{SHAPEB}. This is consistent with important stem structures in conservered
...
The above simulation show that hitchhiking can explain the obervation of
...
is genetic drift, i.e. nonheritable fluctuations in offspring number, our
