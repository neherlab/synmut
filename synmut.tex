...
arbitrary fitness functions can be specified. We used an outcrossing rate of
$r=0.01$ per day \citep{batorsky_estimate_2011, neher_recombination_2010},
a mutation rate of $\mu=2 \times 10^{-5}$ \citep{mansky_lower_1995, abram_nature_2010}.
We performed the simulations with
generation times of both 1 and 2 days, because this parameter varies across patients
\citep{perelson_hiv-1_1996, perelson_decay_1997}; our conclusions are shown in
did not change. We simulated intrapatient
...
The simulations were repeated 1000 times with a four dimensional Latin hypercube sampling scheme.
For two parameters, ranges were chosen around estimates from the recent literature:
the average escape rate $\epsilon$ of escape mutation was sampled such that its logarithm was
uniform between $2 \cdot 10^{-2.5}$ and $2 \cdot 10^{-1.5}$
\citep{neher_recombination_2010} and the rate $k_A$ of new antibody
challenges such that its logarithm was uniform between $10^{-3}$ and $10^{-2}$
per generation \citep{richman_rapid_2003, moore_limited_2009}.
For the other two parameters, ranges were determined to include all simulations
that reproduced the experimental data: the fraction of deleterious sites $\alpha$ was sampled uniformly
between 0.75 and 1.0; the average deleterious effect $s_d$ was sampled such that
its logarithm was uniformly distributed  between $2 \cdot 10^{-4}$ and $2 \cdot
10^{-2}$. Populations were initialized with a homogeneous founder
