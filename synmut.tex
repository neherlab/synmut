...
Recent studies have shown that genetically engineered HIV strains with altered codon usage can in some cases produce more viral protein, but in general replicate less efficiently~\citep{ngumbela_quantitative_2008,
...
\citep{forsdyke_reciprocal_1995,snoeck_mapping_2011} and it has been
shown that rates of evolution at synonymous sites
vary along the HIV genome \citep{mayrose_towards_2007}.
Positive selection through the host's immune system, however, is restricted to
...
\label{fig:aftnonsyn}}
\caption{\comment{I would like p2 or p10 better here} Time series of frequencies
...
$s_a = 0.01$ per day~\citep{neher_recombination_2010,Asquith:2006p28003}.
...
parameters:
The fraction of deleterious sites $\alpha$ was sampled uniformly between 0.75 and 1.0; the average deleterious effect $s_d$ was sampled such that
...
escape. \comment{need more}
To model recognition of escape variants by the immune system that is catching
up, the beneficial effect of an escape mutation was set to zero with a
probability per generation proportional to the frequency of the escape variant.
...
our purposes. \comment{what happens with empty bins??}
