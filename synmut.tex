...
genomic region have a selection coefficient of the order of $-0.004$, and
...
did not change (see \FIG{simheat} and \figurename~S\gentimetwo, respectively). We simulated intrapatient
...
its logarithm was uniformly distributed  between $2 \cdot 10^{-4}$ and $2 \cdot 10^{-2}$; the
average escape rate $\epsilon$ of escape mutation was sampled such that its logarithm was
uniform between $2 \cdot 10^{-2.5}$ and $2 \cdot 10^{-1.5}$ and the rate $k_A$ of new antibody
...
0.004$. The inverse of $|s_d|$ is of the same order of magnitude as the
...
SNVs have deleterious effects on the order of $0.004$ and that they are
...
deleterious effects are around $-0.004$ and a large fraction of the 
