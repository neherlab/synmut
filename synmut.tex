...
\begin{figure}
\begin{center}
\subfloat{\includegraphics[width=0.48\linewidth]{reactivities_histograms_syn}
\label{fig:SHAPEA}}
\subfloat{\includegraphics[width=0.48\linewidth]{Shankarappa_fixmid_syn_V_regions.pdf}\label{fig:SHAPEB}}
